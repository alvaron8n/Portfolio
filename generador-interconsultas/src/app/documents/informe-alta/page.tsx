...
/**
 * Página: Generador de Informe de Alta
 *
 * Layout de dos columnas:
 * - Izquierda: Formulario de informe de alta
...
import {
  InformeAltaForm,
  InformeAltaFormData,
  informeAltaDefaultTemplate,
  flattenInformeAltaData,
} from '@/features/documents/informe-alta';
...
export default function InformeAltaPage() {
  ...
  const handleGenerate = (data: InformeAltaFormData) => {
    setLoading(true);
    setError(null);

    try {
      const variables = flattenInformeAltaData(data);
      const text = buildDocumentText(informeAltaDefaultTemplate, variables);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Genera un informe de alta completo con diagnósticos, evolución y recomendaciones.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <InformeAltaForm onGenerate={handleGenerate} loading={loading} />
        </div>
      ...
      <footer className="mt-12 text-center text-sm text-gray-500">
        <p>
          Generador de Informes Médicos v2.0 &middot; Informe de Alta
        </p>
